...
**September 5, 2025 Update: The Oceania project is now using RecoNIC with ERNIC 4.0 and QDMA 5.0. Please use upgrade/ernic_4 branch. **

**March 31, 2025 Update: The Oceania project is successfully upgraded to use ERNIC 4.0 and QDMA 5.0. We are working with the RecoNIC maintainer to upstream this upgrade, and it will be available to users soon!**
