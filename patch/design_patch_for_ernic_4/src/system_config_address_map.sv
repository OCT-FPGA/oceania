...
// --------------------------------------------------
//   0x600000  |  0x63FFFF |  Card Management System
// --------------------------------------------------
//   0x640000  |  0x640FFF |  QSPI 
// --------------------------------------------------
...
module system_config_address_map #(
  ...
  localparam C_CMS_INDEX   = 11;
  localparam C_QSPI_INDEX  = 12;
  ...
  localparam C_CMS_BASE_ADDR   = 32'h600000; // 18 bits
  localparam C_QSPI_BASE_ADDR  = 32'h640000; // 12 bits
