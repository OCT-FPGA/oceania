...
set_property -dict {
    ...
    CONFIG.M09_A00_BASE_ADDR {0x0000000000500000}
    CONFIG.M10_A00_BASE_ADDR {0x0000000000400000}
    CONFIG.M11_A00_BASE_ADDR {0x0000000000600000}
    CONFIG.M12_A00_BASE_ADDR {0x0000000000640000}
    ...
    CONFIG.M08_A00_ADDR_WIDTH {21}
    CONFIG.M09_A00_ADDR_WIDTH {20}
    CONFIG.M10_A00_ADDR_WIDTH {20}
    CONFIG.M11_A00_ADDR_WIDTH {18}
