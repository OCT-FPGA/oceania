...
xvlog $xvlog_opts -work reco -L cam_v2_5_0 -sv -L vitis_net_p4_v1_3_0 \
--include "../build/ip/packet_parser/hdl" --include "../build/ip/packet_parser/src/hw/include" \
--include "$XVIP_INCLUDE" \
"../build/ip/packet_parser/src/hw/simulation/vitis_net_p4_dpi_pkg.sv" \
...
"../build/ip/packet_parser/src/verilog/packet_parser_extern_wrapper.sv"
...
xvhdl $xvhdl_opts -work reco -L ernic_v4_0_1 \
...
xvlog $xvlog_opts -work reco -sv -L ernic_v4_0_1 -i ../build/ip/rdma_core/hdl/common \
"../build/ip/rdma_core/synth/rdma_core.sv"

xvlog $xvlog_opts -sv -L xpm -L ernic_v4_0_1 -L axi_bram_ctrl_v4_1_6 -d DEBUG -work reco \
