...
# create_pblock pblock_packet_adapter_tx
# add_cells_to_pblock [get_pblocks pblock_packet_adapter_tx] [get_cells -quiet {cmac_port*.packet_adapter_inst/tx_inst}]
# resize_pblock [get_pblocks pblock_packet_adapter_tx] -add {SLR1}
#
# create_pblock pblock_packet_adapter_rx
# add_cells_to_pblock [get_pblocks pblock_packet_adapter_rx] [get_cells -quiet {cmac_port*.packet_adapter_inst/rx_inst}]
# resize_pblock [get_pblocks pblock_packet_adapter_rx] -add {SLR1}

create_pblock pblock_packet_adapter_tx
add_cells_to_pblock [get_pblocks pblock_packet_adapter_tx] [get_cells -quiet {cmac_port*.packet_adapter_inst/tx_inst}]
resize_pblock [get_pblocks pblock_packet_adapter_tx] -add {SLICE_X77Y327:SLICE_X128Y479 DSP48E2_X10Y126:DSP48E2_X16Y185 RAMB18_X5Y132:RAMB18_X8Y191 RAMB36_X5Y66:RAMB36_X8Y95 URAM288_X1Y88:URAM288_X2Y127}
